...
class ImprimerDocA5():
    ...
    def go(self, fichier='fichier.pdf', format=A5, topMargin=10):#┌
        try:
            self.doc = SimpleDocTemplate(fichier,pagesize=format, rightMargin=72,leftMargin=72,topMargin=10,bottomMargin=10)
